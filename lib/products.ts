export const PRODUCTS = [
  ...
  },
  {
    ...
    tags: ["niacinamide", "serum", "hydration", "dry skin", "sensitive skin"],
  ...
  },
  {
    ...
    specs: {
      "Skin Type": "All Skin Types",
      "Key Ingredient": "Niacinamide, Rice Water",
      "Texture": "Serum",
      "Use": "Daily"
    },
    tags: ["niacinamide", "serum", "rice water", "pigmentation"],
    concerns: ["pigmentation", "oily skin", "dullness"],
    image: "/products/Plum-Niacinamide.jpg",
  ...
  },
  {
    ...
    reviews: "5k",
    asin: "B0848GX3P6",
    description: "Niacinamide combined with Ginger extract for brightening and acne control. Widely available across India, well-tolerated, and gentle enough for daily use. Good first serum if you're completely new to actives.",
    specs: {
      "Skin Type": "All Skin Types",
    ...
    tags: ["niacinamide", "serum", "ginger", "acne"],
  ...
  },
  {
    ...
    description: "5% Niacinamide combined with Zinc and Panthenol (B5) for soothing, hydrating, and regulating oil production. Excellent for beginners.",
    specs: {
      "Skin Type": "All Skin Types",
      "Key Ingredient": "Niacinamide, Zinc, Panthenol (Vitamin B5)",
      "Texture": "Serum",
      "Use": "Daily"
    },
    tags: ["niacinamide", "serum", "zinc", "panthenol"],
    concerns: ["oiliness", "acne", "sensitivity"],
