...
export const DICTIONARY: Record<Locale, Record<string, string>> = {
 ...
 "hero.title2": "unfiltered.",
 "hero.copy": "We analyze ingredient science, cross-reference clinical research, and curate the market's best products. No marketing fluff—just clear education, product matches, and a smart dashboard to track your routine.",
