...
const NAV = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/dashboard/conflicts", label: "Conflict Checker", icon: <WarningIcon /> },
  ...
  return (
    <aside className="dash-sidebar">
      ...
      <div className="dash-sidebar-brand">
        <Link href="/dashboard" className="dash-sidebar-brand-name" prefetch={true}>
          MIRHA &amp; CO.
        </Link>
        <Link href="/" className="dash-back-link" prefetch={true}>
      ...
      <div className="dash-sidebar-footer" style={{ 
        ...
        <Link href="/dashboard/subscription" prefetch={true} style={{
          display: "block",
