...
## 6. Git Push Protocol
* **NEVER execute `git push` (to github, gitlab, or any other remote) without explicit user permission or confirmation.**
* Always ask the user first before pushing any commits or branches.
