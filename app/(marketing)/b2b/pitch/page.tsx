...
export default function B2BPitchDeck() {
  ...
  const handleSubscribe = async (tier: "growth" | "scale") => {
    if (!leadEmail || !leadBrand) {
      alert("Please fill in your Work Email and Brand Name in the form below first.");
      return;
    }
              ...
              <div>
                ...
                <div className="pricing-deck">
                  <div className="tier-card">
                    ...
                    >
                      {checkoutLoading === "growth" ? "Opening..." : "Subscribe — Growth"}
                    </button>
                  </div>
                  ...
                  <div className="tier-card popular">
                    ...
                    <button
                      ...
                      style={{ width: "100%", justifyContent: "center" }}
                    >
                      {checkoutLoading === "scale" ? "Opening..." : "Subscribe — Scale"}
                    </button>
                  </div>
                  ...
                  <div className="tier-card" style={{ background: "rgba(255,255,255,0.01)" }}>
                    <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", height: "100%" }}>
                      ...
                      <a href="mailto:b2b@mirhaandco.com" className="pitch-btn-outline" style={{ width: "100%", justifyContent: "center", textAlign: "center" }}>
                        Contact Sales
                      </a>
                    </div>
                  </div>
