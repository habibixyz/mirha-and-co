...
export default function GiftGuidePost() {
 ...
 .post-body .verdict-box p.post-body .verdict-box p.verdict-label, .verdict-label { font-family: 'Bebas Neue', sans-serif; font-size: 1.2rem; letter-spacing: 0.1em; color: #7c6b4a; margin-bottom: 1rem; }
