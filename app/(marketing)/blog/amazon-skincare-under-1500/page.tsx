  ...
  return (
    <main>
      <style>{`
        ...
        .post-body .verdict-box p.verdict-label, .verdict-label { font-family: 'Bebas Neue', sans-serif; font-size: 1.2rem; letter-spacing: 0.1em; color: var(--rose); margin-bottom: 1rem; }
        .post-body .verdict-box p.verdict-text, .verdict-text { font-size: 0.95rem; color: rgba(255,255,255,0.75); line-height: 1.8; font-family: 'DM Sans', sans-serif; }
