    ...
    <main style={{ background: "var(--bg)", color: "var(--ink)", minHeight: "100vh" }}>
      ...
      <article style={{ maxWidth: 720, margin: "0 auto", padding: "3rem 1.5rem 5rem" }}>
        ...
        <section style={{ background: "var(--ink)", borderRadius: 12, padding: "2.5rem", textAlign: "center" }}>
          <h2 style={{ fontFamily: "'DM Serif Display', serif", fontSize: "1.5rem", fontWeight: 400, color: "#fff", margin: "0 0 0.8rem" }}>Get a Routine Built for Your Climate</h2>
          <p style={{ fontSize: "0.9rem", color: "rgba(255,255,255,0.7)", lineHeight: 1.7, margin: "0 0 1.5rem" }}>Our skin quiz factors in your skin type, concerns, and budget to recommend the right products for Indian conditions year-round.</p>
