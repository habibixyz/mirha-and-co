...
export function AnalysisClient({
 ...
 `🧬 My AI Skin Scan Results from Mirha & Co.\n\n` +
 `Moisture Barrier: ${report.barrierScore}/100\n` +
 `Acne/Congestion: ${report.acneScore}/100\n` +
 `Redness: ${report.rednessScore}/100\n` +
 `Oil Control: ${report.oilinessScore}/100\n\n` +
 `Get your free daily scan 👇\nhttps://www.mirhaandco.com/tools/analysis`
 )}`}
 target="_blank"
